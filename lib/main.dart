...
class MyAppState extends ChangeNotifier {
  ...
  void deleteFavorite(WordPair temp) {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Padding(
          padding: const EdgeInsets.all(8.0),
          child: Text('vatsalr22@iitk.ac.in', textAlign: TextAlign.left),
        ),
        Row(
          children: [Icon(Icons.location_on), Text('City:Noida')],
        ),
        SizedBox(height: 10),
        Row(
          children: [Icon(Icons.shopping_bag), Text('Roll No:221179')],
        )
      ],
    );
  }
